...
export default function Home() {
  ...
  const pages = [
    { title: 'Submission List', path: '/submission-list', description: 'All Submissions grid matching Connected Underwriting front-end' },
    { title: 'Create Submission', path: '/create-submission', description: 'Multi-step wizard to create a new insurance submission' },
    { title: 'Submission Summary', path: '/submission-summary', description: 'Submission record view with Overview, Risk, Docs, and Details sidebar' },
    { title: 'Submission Confirmation', path: '/submission-confirmation', description: 'Confirmation screen after submission creation' },
    ...
    { title: 'Financial Performance', path: '/financial-performance', description: 'Underwriting financial analysis interface' },
  ]
