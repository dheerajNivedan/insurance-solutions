...
const pages = [
  ...
  { path: '/submission-list', title: 'Submission List', component: SubmissionList },
  { path: '/create-submission', title: 'Create Submission', component: CreateSubmission },
  { path: '/submission-confirmation', title: 'Submission Confirmation', component: SubmissionConfirmation },
